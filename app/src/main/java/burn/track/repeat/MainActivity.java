...
import burn.track.repeat.Adapters.CycleRoundsAdapter;
import burn.track.repeat.Adapters.DotsAdapter;
import burn.track.repeat.Adapters.LapAdapter;
import burn.track.repeat.Adapters.PomDotsAdapter;
import burn.track.repeat.Adapters.SavedCycleAdapter;
import burn.track.repeat.Adapters.SavedPomCycleAdapter;
import burn.track.repeat.Canvas.LapListCanvas;
import burn.track.repeat.Database.Cycles;
import burn.track.repeat.Database.CyclesDatabase;
import burn.track.repeat.Database.DailyCalorieClasses.CaloriesForEachFood;
import burn.track.repeat.Database.DailyStatClasses.DailyStatsAccess;
import burn.track.repeat.Database.DailyStatClasses.DailyStatsFragment;
import burn.track.repeat.Database.DailyStatClasses.StatsForEachActivity;
import burn.track.repeat.Database.PomCycles;
import burn.track.repeat.Miscellaneous.CalorieIteration;
...
import burn.track.repeat.Miscellaneous.TextViewDisplaySync;
import burn.track.repeat.Miscellaneous.TimerIteration;
import burn.track.repeat.Miscellaneous.VerticalSpaceItemDecoration;
import burn.track.repeat.SettingsFragments.DisclaimerFragment;
import burn.track.repeat.SettingsFragments.ChangeSettingsValues;
import burn.track.repeat.SettingsFragments.ColorSettingsFragment;
import burn.track.repeat.SettingsFragments.RootSettingsFragment;
import burn.track.repeat.SettingsFragments.SoundSettingsFragment;
import burn.track.repeat.SettingsFragments.tdeeSettingsFragment;
...
public class MainActivity extends AppCompatActivity implements SavedCycleAdapter.onPauseOrResumeListener, SavedCycleAdapter.onCycleClickListener, SavedCycleAdapter.onHighlightListener, SavedCycleAdapter.onTdeeModeToggle, SavedPomCycleAdapter.onPauseOrResumeListener, SavedPomCycleAdapter.onCycleClickListener, SavedPomCycleAdapter.onHighlightListener, CycleRoundsAdapter.onFadeFinished, CycleRoundsAdapter.onRoundSelected, SavedCycleAdapter.onResumeOrResetCycle, SavedPomCycleAdapter.onResumeOrResetCycle, RootSettingsFragment.onChangedSettings, SoundSettingsFragment.onChangedSoundSetting, ColorSettingsFragment.onChangedColorSetting, DailyStatsFragment.changeOnOptionsItemSelectedMenu, DailyStatsFragment.changeSortMenu, DotsAdapter.sendDotAlpha, PomDotsAdapter.sendPomDotAlpha {
  ...
  PopupWindow sortPomodoroPopupWindow;
  ...
  TextView sortHigh;
  TextView sortLow;
  TextView sortCycleMostRecent;
  TextView sortCycleLeastRecent;

  TextView sortPomCycleTitleAtoZ;
  TextView sortPomCycleTitleZtoA;
  TextView sortPomCycleMostRecent;
  TextView sortPomCycleLeastRecent;
  ...
  int sortModeForActivities = 1;
  int sortModeForFoodConsumed = 1;
...
//      inputMethodManager.toggleSoftInput(InputMethodManager.SHOW_FORCED,0);
  ...
  private void toggleSortViewsBetweenWorkoutAndPomodoro(int typeOfSort) {
    if (typeOfSort == SORTING_CYCLES) {
      sortPopupWindow.setContentView(sortCyclePopupView);
    }
    if (typeOfSort == SORTING_POMODORO) {
      sortPopupWindow.setContentView(sortPomodoroPopupView);
    }
  }
...
//      appNameHeader2.setTextSize(13);
  ...
  private void assignSortPopUpLayoutClassesToTheirIds() {
    ...
    sortCycleMostRecent = sortCyclePopupView.findViewById(R.id.sort_most_recent);
    sortCycleLeastRecent = sortCyclePopupView.findViewById(R.id.sort_least_recent);

    sortPomCycleTitleAtoZ = sortPomodoroPopupView.findViewById(R.id.sort_title_start_pom);
    sortPomCycleTitleZtoA = sortPomodoroPopupView.findViewById(R.id.sort_title_end_pom);
    sortPomCycleMostRecent = sortPomodoroPopupView.findViewById(R.id.sort_most_recent_pom);
    sortPomCycleLeastRecent = sortPomodoroPopupView.findViewById(R.id.sort_least_recent_pom);
  ...
  private void instantiatePopUpViewsAndWindows() {
    ...
    sortPomodoroPopupView = inflater.inflate(R.layout.sort_pom_cycles_popup, null);
  ...
  private void retrieveAndImplementCycleSorting() {
    ...
    sortModeForActivities = sharedPreferences.getInt("sortModeForActivities", 1);
    sortModeForFoodConsumed = sharedPreferences.getInt("sortModeForFoodConsumed", 1);
  ...
  private void highlightCyclesSortTextView() {
    ...
    switch (sortMode) {
      ...
      case 6:
        ...
        break;
      case 7:
        sortCycleMostRecent.setBackgroundColor(colorToHighlight);
        break;
      case 8:
        sortCycleLeastRecent.setBackgroundColor(colorToHighlight);
        break;
    }
  }
  ...
  private void highlightPomSortTextView() {
    ...
    switch (sortModePom) {
      case 1:
        ...
        break;
      case 2:
        sortPomCycleTitleZtoA.setBackgroundColor(colorToHighlight);
        break;
      case 3:
        sortPomCycleMostRecent.setBackgroundColor(colorToHighlight);
        break;
      case 4:
    ...
    return view -> {
      ...
      AsyncTask.execute(() -> {
        ...
        runOnUiThread(() -> {
          ...
          prefEdit.putInt("sortModeForActivities", sortModeForActivities);
          prefEdit.apply();
  ...
  private void highlightSelectedSortTextViewForActivitiesInStatsFragment() {
    ...
    switch (sortModeForActivities) {
      case 1:
        sortActivityStatsAToZTextView.setBackgroundColor(colorToHighlight);
        break;
      case 2:
        sortActivityStatsZToATextView.setBackgroundColor(colorToHighlight);
        break;
      case 3:
        sortActivityStatsByMostTimeTextView.setBackgroundColor(colorToHighlight);
        break;
      case 4:
    ...
    return view -> {
      ...
      AsyncTask.execute(() -> {
        ...
        runOnUiThread(() -> {
          ...
          prefEdit.putInt("sortModeForFoodConsumed", sortModeForFoodConsumed);
          prefEdit.apply();
        });
      });
    };
  ...
  private void highlightSelectedSortTextViewForFoodsInStatsFragment() {
    ...
    switch (sortModeForFoodConsumed) {
      case 1:
        sortFoodConsumedStatsAToZTextView.setBackgroundColor(colorToHighlight);
        break;
      case 2:
        sortFoodConsumedStatsZToATextView.setBackgroundColor(colorToHighlight);
        break;
      case 3:
        sortFoodConsumedCaloriesByMostTextView.setBackgroundColor(colorToHighlight);
        break;
      case 4:
  ...
  private void queryAndSortAllCyclesFromMenu() {
    switch (sortMode) {
      ...
      case 6:
        ...
        break;
      case 7:
        cyclesList = cyclesDatabase.cyclesDao().loadCyclesByMostRecent();
        break;
      case 8:
