...
//  ImageView sortCheckMark;
  ...
  //Todo: Clicking twice on same week/month (in week/month mode) will un-highlight and not highlight again until we've selected a different week/month (due to list.equals() conditional). -->>>>
      //Todo: Maybe: Should switch modes from week/month/year to daily if we click on a date within the current range.
