...
@Database(entities = {Cycles.class, PomCycles.class, ActivitiesForEachDay.class, StatsForEachActivityWithinCycle.class, PomCycleStats.class, DayHolder.class}, version = 1, exportSchema =  false)
